...
const Services = () => {
  return (
    <div>
   <div className="max-w-4xl mx-auto px-5 mt-16 pb-12">

<div className="text-center">
    <h2 className="font-semibold text-3xl">Features you'll love</h2>
    <p className="max-w-md mx-auto mt-2 text-gray-500">Unleash Your Creativity, Share Your Stories</p>
</div>
...
<div className="grid md:grid-cols-2 gap-10 mt-10">
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl"> Intuitive Writing Interface</h3>
    ...
    <div className="flex gap-4 items-start">
        ...
        <div>
            <h3 className="font-semibold text-xl">Customizable Themes</h3>
